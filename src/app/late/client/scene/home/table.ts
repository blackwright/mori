...
export class Table extends Renderer {
  ...
  top() {
    const { ctx, y, windowFrameThickness, oneThirdCanvasWidth, roundedRadius } =
      this;
  ...
  leg() {
    const { ctx, y, windowFrameThickness, canvasHeight, oneThirdCanvasWidth } =
      this;
  ...
  centerpiece() {
    const { ctx, y, windowFrameThickness, canvasWidth, oneThirdCanvasWidth } =
      this;
