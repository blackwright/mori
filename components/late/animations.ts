...
export function useAnimations() {
  ...
  const grayscaleFlashSequence = React.useCallback(async () => {
  ...
  const outdoorFlashSequence = React.useCallback(async () => {
  ...
  const indoorFlashSequence = React.useCallback(async () => {
  ...
  const flashSequence = React.useCallback(async () => {
